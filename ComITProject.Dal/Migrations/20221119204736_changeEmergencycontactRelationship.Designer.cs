...
namespace ComITProject.Dal.Migrations
{
    ...
    [Migration("20221119204736_changeEmergencycontactRelationship")]
    partial class changeEmergencycontactRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ComITProject.Dal.Model.EmergencyContact", b =>
                {
                    b.HasOne("ComITProject.Dal.Model.Patient", "Patient")
                        ...
                        .HasForeignKey("ComITProject.Dal.Model.EmergencyContact", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
